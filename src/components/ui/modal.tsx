...
export function Modal({
  ...
  if (!open) return null;
  const modalParent = clsx("relative p-4", sizeMaper[size]);
  return (
    <>
      <div
        className={clsx(
          "overflow-y-auto flex fixed top-0 right-0 left-0 bottom-0  z-50 justify-center items-center md:inset-0"
        )}
      >
